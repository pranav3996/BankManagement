...
public class CustomerUpdate {
	...
	public CustomerUpdate(int c_id, String firstName, String middleName, String lastName, String email, long mobileNumber,
	...
	public String toString() {
		return "CustomerUpdate [C_id=" + c_id + ", firstName=" + firstName + ", middleName=" + middleName + ", lastName="
